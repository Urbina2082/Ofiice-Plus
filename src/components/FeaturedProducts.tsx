...
const products: Product[] = [
  { id: 1, name: 'Set de bolígrafos Premium', price: 29.99, image: '/product-1.jpg' },
  { id: 2, name: 'Cuaderno Profesional A4', price: 24.99, image: '/product-2.jpg' },
  { id: 3, name: 'Organizador de Escritorio', price: 34.99, image: '/product-3.jpg' },
  { id: 4, name: 'Calculadora Científica', price: 29.99, image: '/product-4.jpg' },
  ...
  { id: 7, name: 'Set Marcadores Colores', price: 56.99, image: '/product-7.jpg' },
